...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    marks={int(min_value): str(int(min_value)),
                                        int(max_value): str(int(max_value))}
                                ),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        outcomes = spacex_df['class'].value_counts().reset_index()
...
def update_scatter_chart(selected_site, payload_range):
    ...
    filtered_df = spacex_df[(spacex_df['Payload Mass (kg)'] >= min) & 
